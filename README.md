...
This skill only uses lawful open-access sources, author/repository copies, PMC/arXiv, publisher OA files, or user-provided PDFs. It does not use shadow libraries or credential bypasses.
